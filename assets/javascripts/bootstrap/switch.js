  ...
  (function($, window) {
    ...
    Switch = (function() {
      function Switch(element, options) {
        ...
        this.options = $.extend({}, $.fn.Switch.defaults, {
        ...
        this.$element.on("init.Switch", (function(_this) {
          return function() {
            return _this.options.onInit.apply(element, arguments);
          };
        })(this));
        this.$element.on("switchChange.Switch", (function(_this) {
          return function() {
        ...
        this.$element.before(this.$on).before(this.$label).before(this.$off).trigger("init.Switch");
      ...
      Switch.prototype.wrapperClass = function(value) {
        ...
        if (!value) {
          value = $.fn.Switch.defaults.wrapperClass;
        }
      ...
      Switch.prototype.onInit = function(value) {
        ...
        if (!value) {
          value = $.fn.Switch.defaults.onInit;
        }
      ...
      Switch.prototype.onSwitchChange = function(value) {
        ...
        if (!value) {
          value = $.fn.Switch.defaults.onSwitchChange;
        }
      ...
      Switch.prototype.destroy = function() {
        ...
        if ($form.length) {
          $form.off("reset.Switch").removeData("bootstrap-switch");
        }
        this.$container.children().not(this.$element).remove();
        this.$element.unwrap().unwrap().off(".Switch").removeData("bootstrap-switch");
        return this.$element;
      };
          ...
          "change.Switch": (function(_this) {
            return function(e, skip) {
              ...
              if (!skip) {
                ...
                return _this.$element.trigger("switchChange.Switch", [checked]);
              }
            };
          })(this),
      ...
      Switch.prototype._labelHandlers = function() {
        return this.$label.on({
          "mousemove.Switch touchmove.Switch": (function(_this) {
            return function(e) {
          ...
          "mousedown.Switch touchstart.Switch": (function(_this) {
            return function(e) {
          ...
          "mouseup.Switch touchend.Switch": (function(_this) {
            return function(e) {
              if (!_this.isLabelDragging) {
                return;
              }
          ...
          "mouseleave.Switch": (function(_this) {
            return function(e) {
              return _this.$label.trigger("mouseup.Switch");
            };
          })(this)
        });
      };
        ...
        return $form.on("reset.Switch", function() {
          return window.setTimeout(function() {
            return $form.find("input").filter(function() {
              ...
              return $(this).Switch("state", this.checked);
            });
          }, 1);
    ...
    $.fn.Switch = function() {
      ...
      this.each(function() {
        ...
        if (!data) {
          $this.data("bootstrap-switch", data = new Switch(this, option));
        }
